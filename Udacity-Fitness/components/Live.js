    ...
    render(){
        ...
        if(status === 'undetermined'){
            return(
                <View style={styles.center}>
                    <Foundation name='alert' size={50} />
                    <Text>You need to enabled location services for this app.</Text>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.metricContainer}>
                    <View style={styles.metric}>
                        ...
                        <Text style={[styles.subHeader, {color: white}]}> {coords !== null ? Math.round(coords.altitude * 3.2808) : 0} Feet</Text>
                    </View>

                    <View style={styles.metric}>
                        <Text style={[styles.header, {color: white}]}> Speed</Text>
                        <Text style={[styles.subHeader, {color: white}]}> {coords !== null ? (coords.speed * 2.2369).toFixed(1) : 0} MPH</Text>
                    </View>
                </View>
            </View>
        )
